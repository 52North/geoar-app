...
public class MainActivity2 extends ActionBarActivity {
	...
	tabsAdapter.addtab(tabHost.newTabSpec("Installed").setIndicator("Installed"), DatasourceGridFragment.class,
		null);
	tabsAdapter.addtab(tabHost.newTabSpec("Codebase").setIndicator("Codebase"), CodebaseGridFragment.class, null);
     ...
     */
    public static class CBTabsAdapter extends FragmentPagerAdapter implements ViewPager.OnPageChangeListener,
	...
	public CBTabsAdapter(FragmentActivity context, ViewPager viewPager, TabHost tabHost) {
	...
	public Fragment getItem(int arg0) {
	    ...
	    return Fragment.instantiate(context, tabInfo.thisFragmentClass.getName(), tabInfo.thisArgs);
	}
	...
	public void addtab(TabHost.TabSpec tabSpec, Class<?> fragmentClass, Bundle args) {
	    tabSpec.setContent(new DummyTabFactory(context));
	    CBTabInfo tabInfo = new CBTabInfo(tabSpec.getTag(), fragmentClass, args);
	    tabs.add(tabInfo);
