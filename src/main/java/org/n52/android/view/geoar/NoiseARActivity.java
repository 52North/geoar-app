...
import org.n52.android.data.NoiseDroidLocalSource;
import org.n52.android.data.NoiseDroidServerSource;
...
import org.n52.android.view.map.NoiseMapView;
...
public class NoiseARActivity extends MapActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (lastMeasureManager != null) {
			...
			measurementManager = new MeasurementManager(dataSources[0]);
		}
		...
		// MapView
		NoiseMapView noiseMapView = (NoiseMapView) findViewById(R.id.noiseMapView);
