...
public abstract class Renderer {
	...
	public void initShaders(){
		...
		modelMatrixHandle = GLES20.glGetUniformLocation(programHandle, "u_MMatrix");
		viewMatrixHandle = GLES20.glGetUniformLocation(programHandle, "u_VMatrix");
	}
	...
	public void setVertices(final int vertexBufferHandle){
		if(vertexBufferHandle >= 0){
			...
			Log.d(this.getClass().getSimpleName(), "vertexbufferhandle is not a valid handle");
		}
	}
	...
	public void setNormals(final int normalBufferHandle){
		if(normalBufferHandle >= 0){
			...
			Log.d(this.getClass().getSimpleName(), "normalbufferhandle is not a valid handle");
		}
	}
	...
	public void setColors(final int colorBufferHandle){
		if(colorBufferHandle >= 0){
			...
			Log.d(this.getClass().getSimpleName(), "colorbufferhandle is not a valid handle");
		}
	}
	
	public void setRenderMatrices(float[] mvpMatrix, float[] modelMatrix, float[] viewMatrix){
