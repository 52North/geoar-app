...
public class Picking {
	...
	/**
	 * Gibt den Schnittpunkt mit der Interpolationsebene zurï¿½ck.
	 * Parameterbezeichnung fï¿½r Fall der oberen Grenzlinie
	 * 
	 * @param model
	 *            Model-View Matrix
	 * @param project
	 ...
	 * @param winYOpp
	 *            Y Koordinate vertikal der gegenï¿½berliegenden Ecke
	 * @param winX
	 *            X Koordinate ausgehen derer Schnittpunkt gesucht wird
	 * @param winXOpp
	 *            X Koordinate horizontal der gegenï¿½berliegenden Ecke
	 * @return
	 */
