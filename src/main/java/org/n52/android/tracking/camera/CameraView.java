...
public class CameraView extends SurfaceView implements Callback {
	...
	/**
	 * Methode ï¿½bernommen aus Android API Demos, siehe
	...
	public void surfaceChanged(SurfaceHolder holder, int format, int width,
		...
		if (camera == null)
			return;
		// ï¿½nderung des Surface fï¿½r Kameravorschau berï¿½cksichtigen
		...
		// Annahme, dass Kamera 90ï¿½ verdreht zu Standardausrichtung platziert
		// ist. Tatsï¿½chlicher Wert erst ab Android 2.3 abrufbar. TODO
